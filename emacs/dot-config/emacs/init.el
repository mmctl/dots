...
(setq display-buffer-alist
      '(((or (derived-mode . (Info-mode help-mode shortdoc-mode epa-info-mode apropos-mode man-common))
             (derived-mode . (ibuffer-mode occur-mode grep-mode xref--xref-buffer-mode)))
         ...
         (preserve-size . (t . nil)))
        ((derived-mode . (messages-buffer-mode compilation-mode emacs-lisp-compilation-mode backtrace-mode))
         ;; (display-buffer-reuse-window display-buffer-in-side-window)
         (display-buffer-in-side-window)
         (reusable-frames . visible)
         (side . bottom)
